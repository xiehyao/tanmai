...
class CreatePostRequest(BaseModel):
    ...
    activity_key: Literal["tea", "innovation", "sport", "food"] = "tea"
...
def _ensure_tables_and_seed(db: Session):
    ...
    defaults = [
        ...
        },
        {
            ...
            "content": "周日早上深圳湾10公里慢跑局，欢迎不同配速的校友一起动起来。",
            "images_json": "[]",
            "location": "深圳湾公园",
            "activity_key": "sport",
            "enable_signup": True,
        ...
        },
        {
            ...
            "author_subtitle": "00通信工程",
            "author_avatar": "https://tanmai-1318644773.cos.ap-guangzhou.myqcloud.com/avatars/male-young-1.png",
            "content": "泉州菜走起，本周五晚南山见。欢迎带朋友一起。",
            "images_json": json.dumps(["https://images.unsplash.com/photo-1559827260-dc66d52bef19?w=600"], ensure_ascii=False),
            "location": "深圳 南山",
            "activity_key": "food",
            "enable_signup": True,
            "like_count": 156,
